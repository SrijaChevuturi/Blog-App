  ...
  return (
    <div className="article-box">
      {articleEditStatus === false ? (
        <>
          <div className="d-flex text-black justify-content-between mx-5">
            <div className="top text-black">
              <p className="display-3 text-black mt-3">{state.title}</p>
              <span className="py-3">
          ...
          {/* <p className="lead mx-5 my-5 mt-1 text-black" style={{ whiteSpace: "pre-line" }}>
            {state.content}
          </p> */}
          <div className="content-box mx-5 my-3">
            <p className="lead mt-1 text-black" style={{ whiteSpace: "pre-line" }}>
              {state.content}
            </p>
          </div>
          {/* user comments */}
          <div>
            ...
            <div className="comments my-4 text-black">
              {state.comments.length === 0 ? (
                <p className="display-3 text-black">No comments yet...</p>
              ) : (
